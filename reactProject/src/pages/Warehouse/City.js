...
export default class Craftsman_Settled extends Component {
    ...
    handleChange(name, e) {
        ...
        switch (name) {
            ...
            case "province":
                this.props.parent.getProvince(e.target.value)
                this.setState({
                ...
                break;
            case "city":
                this.props.parent.getCity(e.target.value)
                this.setState({
                    city: e.target.value,
                ...
                break;
            case "county":
                this.props.parent.getCounty(e.target.value)
                this.setState({
        ...
        return (
           <div>
               <div className="city" style={{display:"flex"}}>
                                      <div style={{border:"1px solid",textAlign:"center",height:"27px",borderRadius:"5px",marginRight:"15px"}}>
                                          <select
                                              // onChange={(e)=>this.props.theProvice(e.target.value)}
                                              className="select myprovince" onClick={this.handleChange.bind(this, "province")} style={{border:"none"}} >
                                        ...
                                        <div style={{border:"1px solid",textAlign:"center",height:"27px",borderRadius:"5px",marginRight:"15px"}}>
                                            <select
                                                // onChange={(e)=>this.props.theCity(e.target.value)}
                                                className="select mycity" onClick={this.handleChange.bind(this, "city")} style={{border:"none"}} >
                                                {this.state.cities.map(city => (
                                                    <option value={city} key={id++}>{city}</option>
                                                ))}
                                            </select>
                                        </div>
                                        <div style={{border:"1px solid",textAlign:"center",height:"27px",borderRadius:"5px"}}>
                                            <select
                                                // onChange={(e)=>this.props.theCountry(e.target.value)}
                                                className="select mycounty" onClick={this.handleChange.bind(this, "county")} style={{border:"none"}}>
