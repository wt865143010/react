...
class editService extends Component {
    ...
    UNSAFE_componentWillMount() {
        console.log(this.props.location.state.record.key);

            this.state.myKey=this.props.location.state.record.key;
        ...
        let arr=[
            {
                ...
                serveCode: this.state.serveCode,
                serveState:this.state.serveState,
                serveLate:this.state.serveLate,
