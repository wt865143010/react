...
const columns = [
    ...
    },
    {
        ...
        dataIndex: 'shenqing_order',
        align: 'center',
    },
    {
        title: '所属订单号',
        dataIndex: 'suoshu_order',
        align: 'center',
    },
    {
        title: '申请人手机号',
    ...
    {
        title: '申请人姓名',
        dataIndex: 'shenqing_name',
        align: 'center',
    },
    {
        title: '申请时间',
        dataIndex: 'shenqing_time',
        align: 'center',
    },
    {
        title: '退货原因',
...

    {
        ...
        render:(text,record)=>(
            <Space  size="middle">
                ...
                <Link to={
                    {
                        pathname:"/order/Return_order/Return_orderDetail",
                        query:{id:record.shenqing_order}
                    }
                }>详情</Link>
            </Space>
        )
...
class Return_Order extends Component {
    ...
    UNSAFE_componentWillMount() {
        this.props.myorder.return_list()
            .then(data=>{
