...
export default class Craftsman_Settled extends Component {
    ...
    handleChange(name, e) {
        ...
        console.log("省:"+this.state.province)
        console.log("市:"+this.state.city)
        console.log("区:"+this.state.county)

        /*console.log(sheng)
        console.log(shi)
        console.log(qu)*/
        let obj={
            mysheng:this.state.province,
            myshi:this.state.city,
            myqu:this.state.county
        }
        console.log(obj);
        this.props.theCity(obj);
        ...
        return (
           <div>
               <div className="city">
                                        ...
                                        <select
                                            // onChange={(e)=>this.props.theCity(this.state.province)}
                                        ...
                                        <select
                                            // onChange={(e)=>this.props.theShi(this.state.city)}
                                        ...
                                        <select
                                            // onChange={(e)=>this.props.theQu(this.state.county)}
               ...
               {/*<div>
                   <button onClick={this.myquyu.bind(this)}>获取</button>
               </div>*/}
           </div>
        )
    }
