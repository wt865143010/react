...

    {
        ...
        render:(text,record)=>(
            <Space  size="middle">
                ...
                <Link to={
                    {
                        pathname:"/order/Invoice/InvoiceDetail" ,
                        query:{id:record.invoiceOrder_id}
                    }
...
class Invoice extends Component {
    ...
    UNSAFE_componentWillMount() {
        this.props.myorder.invoiceOrder()
            .then(data=>{
